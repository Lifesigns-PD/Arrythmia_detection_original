...
# Configuration
DATA_DIR = str(Path(__file__).resolve().parent.parent / "raw_data" / "mitdb")
FS_ORIGINAL = 360
FS_TARGET = 125
SEGMENT_SECONDS = 10
TARGET_LENGTH = SEGMENT_SECONDS * FS_TARGET  # 1250
    ...
    for record_name in tqdm(records):
        try:
            ...
            for seg_idx in range(num_segments):
                ...
                segment_resampled = resample(segment_360, TARGET_LENGTH)
                ...
                try:
                    _, info = nk.ecg_peaks(segment_resampled, sampling_rate=FS_TARGET)
                ...
                signal_list = segment_resampled.tolist()
